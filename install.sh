#!/usr/bin/env sh
# Universal installer for deidproof. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/deidproof.git"
echo "Installing deidproof ..."
