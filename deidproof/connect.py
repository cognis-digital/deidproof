"""Native cognis-connect emit for deidproof — forward findings to any platform.

Maps deidproof's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    deidproof ... --format json | deidproof-emit --to stix
    deidproof-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
